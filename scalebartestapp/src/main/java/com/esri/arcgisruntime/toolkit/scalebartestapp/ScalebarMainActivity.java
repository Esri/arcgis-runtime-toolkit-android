...
public final class ScalebarMainActivity extends AppCompatActivity implements ScalebarStyleDialogFragment.Listener,
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    // Inflate the options menu; this adds items to the action bar
  ...
  private void changeContentView(int layoutId, int messageStringId) {
    ...
    button.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View view) {
        ...
        changeContentView(R.layout.activity_custom1, R.string.message_custom1);
    ...
    button.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View view) {
        ...
        changeContentView(R.layout.activity_custom2, R.string.message_custom2);
        mScalebar = findViewById(R.id.scalebar);
        mScalebar.bindTo(mMapView);
      }
    });
